...
class TaskListTest {
    ...
    void addTask() {
        ...
        // should have 1 task
        assertEquals("Staff have completed 0 tasks. They are working on 0 and 1 are unassigned.",
                TaskList.getInstance().getStats());
    }
    ...
    void assignAvailableTask() {
        ...
        assertEquals("Staff have completed 0 tasks. They are working on 1 and 0 are unassigned.",
                TaskList.getInstance().getStats());
